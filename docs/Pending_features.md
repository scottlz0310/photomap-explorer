...
- [2025-06-27]アドレスバーのボタンが表示しきれなくなると全体が縮小してしまう。→【fix:xxxx-xx-xx】
　アドレスバーが狭いときは、ルート側から順にボタンを隠し、末尾（子階層）を優先表示する。
- [2025-06-27] ステータスバーの表示が時間で消えてしまう。
- [2025-06-27] 画像が多いフォルダで読み込みが遅い。サムネイル非同期化検討中。
